...
@XmlRootElement(name = "DivNumbersResponse", namespace = "http://div.cal.tum.edu")
public class DivNumbersResponse {

    @XmlElement(namespace = "http://div.cal.tum.edu", required = true)
    protected String n1;
